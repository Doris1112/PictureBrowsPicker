...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.picture_picker_media_grid_content, this, true);

        mThumbnail = findViewById(R.id.picture_picker_media_thumbnail);
        mCheckView = findViewById(R.id.picture_picker_check_view);
        mGifTag = findViewById(R.id.picture_picker_gif);
        mVideoDuration = findViewById(R.id.picture_picker_video_duration);
