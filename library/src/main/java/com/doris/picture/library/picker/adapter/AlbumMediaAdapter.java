...
import com.doris.picture.library.picker.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView) {
        ...
        TypedArray ta = context.getTheme().obtainStyledAttributes(new int[]{R.attr.itemPlaceholder});
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.picture_picker_item_photo_capture, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.picture_picker_item_madia_grid, parent, false);
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            TypedArray ta = holder.itemView.getContext().getTheme().obtainStyledAttributes(
                    new int[]{R.attr.captureTextColor});
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View itemView) {
            super(itemView);
            mHint = itemView.findViewById(R.id.picture_picker_hint);
        }
    }
}
