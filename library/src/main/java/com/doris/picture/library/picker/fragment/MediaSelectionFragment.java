...
import com.doris.picture.library.picker.widget.MediaGridInset;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_picture_picker_media_selection, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mRecyclerView = view.findViewById(R.id.picture_picker_recycler);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (selectionSpec.gridExpectedSize > 0) {
            spanCount = spanCount(getContext(), selectionSpec.gridExpectedSize);
        } else {
    ...
    private int spanCount(Context context, int gridExpectedSize) {
