 ...
 * @date 2018/12/4
 */
public enum  PicturePickerMediaType {
    ...
    PicturePickerMediaType(String mimeTypeName, Set<String> extensions) {
        mMimeTypeName = mimeTypeName;
        mExtensions = extensions;
    }

    public static Set<PicturePickerMediaType> ofAll() {
        return EnumSet.allOf(PicturePickerMediaType.class);
    }

    public static Set<PicturePickerMediaType> of(PicturePickerMediaType type, PicturePickerMediaType... rest) {
        return EnumSet.of(type, rest);
    }

    public static Set<PicturePickerMediaType> ofImage() {
