...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.itemCheckCircleBorderColor});
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.picture_picker_check, context.getTheme());
    }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme()
                    .obtainStyledAttributes(new int[]{R.attr.itemCheckCircleBackgroundColor});
            int defaultColor = ResourcesCompat.getColor(
