...
import com.doris.picture.library.picker.utils.compat.ExifInterfaceCompat;
...
public final class PhotoMetadataUtils {
    ...
    private static boolean isSelectableType(Context context, Item item) {
        ...
        for (PicturePickerMediaType type : SelectionSpec.getInstance().picturePickerMediaTypeSet) {
